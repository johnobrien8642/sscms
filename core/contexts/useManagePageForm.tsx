...
// context file
const models = ['Page', 'Templates', 'Assets', 'BlogPost', 'Settings', 'Text'];
export const {
...
export type ManagePageFormContextType = {
	...
	stopDrag: boolean;
	setStopDrag: React.Dispatch<React.SetStateAction<boolean>>
};
...
export function ManagePageFormProvider({ 
		data, 
		setData, 
		formCache, 
		setFormCache, 
